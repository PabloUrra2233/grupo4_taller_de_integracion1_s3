"""
Django settings for reserva_mesas project.
...
SECRET_KEY = 'django-insecure-ur6rox-^sau&ejk3woti$+gtel05#^ah_zrov=k)+1rc_n6)l#'
...
ROOT_URLCONF = 'reserva_mesas.urls'
...
WSGI_APPLICATION = 'reserva_mesas.wsgi.application'
